...
Gui, Tab, 1
    ...
    Gui, Add, Text, x60 y+2 w820, % "• Если соотношение сторон отличается от идеала (>0.05), возможны проблемы с кликами"
    Gui, Add, Text, x60 y+1 w820, % "	Идеал ~ 1.96. Текущее значение — на вкладке «Настрой здесь»"
    
    Gui, Add, Text, x60 y+1 w820, % "• При поиске миссий «x2 отряда» может задеть кнопки покупки славы/отряда"
    Gui, Add, Text, x60 y+1 w820, % "	Рекомендуется выставить приоритет и следить за кликами"
